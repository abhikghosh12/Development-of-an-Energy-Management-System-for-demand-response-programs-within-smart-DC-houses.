...
within ;
model HPController_demandResponse_dc_SC "HPController_demandResponse_dc_sc.mo"
	...
	input Modelica.Blocks.Interfaces.RealInput EPriceAverage(quantity="price") "price" annotation(
		...
		Dialog(
			...
			tab="Results 1",
			showAs=ShowAs.Result));
	parameter String PriceTable="Pricing" "Table name for Eprice ";
...
----$iti$--"),
		experiment(
			...
			MaxInterval="10",
			AbsTolerance="1e-06"));
end HPController_demandResponse_dc_SC;
