...
model HeatPump111 "Heat pump system"
	protected
	...
	public
		...
		parameter Real QlossRate(
			...
			group="Heat Losses",
			tab="Heat Pump - Dimensions"));
		parameter String HPFile=GreenBuilding.Utilities.Functions.getModelDataDirectory()+"\\heat_pump\\hp_data\\Stiebel_Eltron\\WPL_10_ACS\\SE_WPL_10_ACS.txt" "File name for heat pump characteristics" annotation(Dialog(
			group="Heating Power",
			tab="HP - Power Data"));
